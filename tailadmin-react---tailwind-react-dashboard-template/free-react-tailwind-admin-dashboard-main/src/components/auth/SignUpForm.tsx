...
import Button from "../ui/button/Button"; // Assurez-vous que ce composant existe
      ...
      case 2:
        return (
          <div>
            <div className="mb-5 sm:mb-8">
              <h1 className="mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                Informations de Connexion et Adresse
              </h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Remplissez vos informations de connexion et adresse.
              </p>
            </div>
            <div className="space-y-5">
              <div>
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div className="sm:col-span-1">
                  <Label>
                    Cité<span className="text-error-500">*</span>
                  </Label>
                  <Input
                    type="text"
                    name="cite"
              ...
              <div className="mt-5">
                <p className="text-sm font-normal text-center text-gray-700 dark:text-gray.shader-400 sm:text-center">
                  Vous avez déjà un compte ?{" "}
                  <Link
                    to="/signin"
                    className="text-brand-500 hover:text-brand-600 dark:text-brand-400"
        ...
        return (
          <div>
            ...
            <div className="space-y-5">
              <div>
                <Label>
                  Spécialité<span className="text-error-500">*</span>
                </Label>
                <Input
                  type="text"
                  name="specialite"
              ...
              <div>
                <Label>
                  Sous-Spécialité<span className="text-error-500">*</span>
                </Label>
                <Input
                  type="text"
                  name="sousSpecialite"
                  ...
                  onChange={handleChange}
                  placeholder="Entrez votre sous-spécialité"
                />
              </div>
              <div className="flex justify-between">
                <Button
